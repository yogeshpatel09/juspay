...
export default function Sidebar() {
    ...
    console.log(sidebarData.dashboards.length)
    ...
    return (
        <div className="w-[212px] h-screen overflow-y-auto  border-r border-gray-200 dark:border-[rgba(255,255,255,0.1)] px-4 py-5 ovey scrollbar-hide">
