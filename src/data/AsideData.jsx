...
import { PiBroadcastBold, PiBugBeetle } from "react-icons/pi";
import { LuUserRound } from "react-icons/lu";
export const AsideData = {
  notifications: [
    { icon: PiBugBeetle, title: "You have a bug that needs to be fixed.", time: "2m ago" },
    { icon: LuUserRound, title: "New user registered", time: "5m ago" },
    { icon: PiBugBeetle, title: "You have a bug that needs to be fixed.", time: "12m ago" },
    { icon: PiBroadcastBold, title: "Andi Lane subscribed to you", time: "25m ago" },
  ],
